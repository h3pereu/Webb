    ...
    <div className="auth-wrap">
      ...
      <div className="auth-grid">
        ...
        <div className="auth-panel auth-left">
          ...
          <p className="subtitle">Join and start searching.</p>

          <ul className="bullets" aria-label="Benefits">
            <li><span className="dot" aria-hidden /> Email or Google sign up</li>
            <li><span className="dot" aria-hidden /> Credits for Live & DB search</li>
            <li><span className="dot" aria-hidden /> Secure session</li>
          </ul>
        ...
        <div className="auth-panel auth-right">
          <div className="card" role="region" aria-label="Signup form">
            ...
            <form onSubmit={onSubmit} className="form" noValidate>
              <div className={"field" + (name ? " has-value" : "")}>
                <input
                  id="name"
                  value={name}
          ...
          <p className="footnote">By signing up you agree to our terms & privacy.</p>
        </div>
      </div>
    </div>
  );
