        ...
        <div className="auth-panel auth-left">
          <div className="brand">
            ...
            <div className="brand-names">
              ...
              <span className="brand-sub">Create your account</span>
            </div>
          </div>
          <h1 className="title">Join Astra</h1>
          <p className="subtitle">Sign up to unlock playlist tools, show management, and more.</p>
        ...
        <div className="auth-panel auth-right">
          <div className="card">
            ...
            <form onSubmit={onSubmit} className="form">
              ...
              <div className={"field" + (password2 ? " has-value" : "")}>
                <input
                  id="password2"
                  type={showPw ? "text" : "password"}
                  value={password2}
          ...
          <p className="footnote">For development use. Add real backend later.</p>
        </div>
      </div>
    </div>
  );
...
const css = `:root {
  --bg: var(--page-bg, #f7f9fc);
  --panel: #ffffff;
  --card: rgba(255,255,255,.86);
  --muted: var(--psl-muted, #6b7280);
  --text: var(--psl-text, #0b0b0c);
  --accent: var(--nav-accent, #6E5BFF);
  --accent-2: var(--nav-accent-2, #A78BFA);
  --ring: rgba(110,91,255,.30);
  --border: var(--psl-border, #e7eaf0);
}
...
.submit{
  ...
  color:#fff; box-shadow:0 14px 34px rgba(110,91,255,.22);
}
